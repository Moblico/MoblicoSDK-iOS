...
MLCServiceCreateResourceCompletionHandler(MLCListsService, MLCList);
MLCServiceCreateCollectionCompletionHandler(MLCListsService, MLCList);

NS_SWIFT_NAME(ListsService)
