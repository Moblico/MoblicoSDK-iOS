...
/**
 ...
 @param MLCUserSocialType <#MLCUserSocialType description#>
...
+ (instancetype)userWithSocialType:(MLCUserSocialType)socialType
                          socialId:(NSString *)socialId
                    socialUsername:(NSString *)socialUsername
                       socialToken:(NSString *)socialToken;
...
__attribute__((deprecated ("Use 'contactPreferenceType' instead.")));
...
__attribute__((deprecated ("Use 'genderType' instead.")));
